# -*- coding: utf-8 -*-
"""
Complete FP-CNY flow: Registration -> SP Auth -> Application -> Webhooks -> E-signature
"""
import hashlib
import json
import logging
...
def main():
    log.info("="*60)
    log.info("FP-CNY Complete Flow: Registration -> E-signature")
    log.info("="*60)
    ...
    send_webhook("approvedoffer.completed", {
        "data": {
            ...
            "details": {
                ...
                "offer": {
                    "approvedLimit": {"amount": "500000", "currency": "CNY"},
    ...
    send_webhook("esign.completed", {
        "data": {
            ...
            "details": {
                "merchantId": merchant_id,
                "lenderApprovedOfferId": lender_offer_id,
                "signedLimit": {"amount": "500000", "currency": "CNY"},
                "result": "SUCCESS"
            }
        }
    })
