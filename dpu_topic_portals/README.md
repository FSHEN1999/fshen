...
- [项目总览与主入口](00-project-map.md): 先定位核心脚本族、Web 接入层、数据库辅助层和长文档来源。 | files=18
- [核心 Mock 状态流](10-mock-core-flow.md): 聚焦注册、核保、审批、PSP、电子签、放款、还款等主流程。 | files=5
- [MeterSphere 与 mockapi 接入](20-metersphere-mockapi.md): 聚焦 FastAPI 接入层、会话模型、接口清单与 MeterSphere 变量设计。 | files=18
- [迁移脚本与 reg 生产回传](30-migration-reg-prod.md): 聚焦 batch1、batch3、多店铺 PSP 绑定、数据导出、回滚与 reg 环境。 | files=9
- [多店铺与 PSP 专题](40-multi-shop-psp.md): 聚焦多店铺绑定、3PL 跳转、PSP 记录插入与额度拆分。 | files=4
