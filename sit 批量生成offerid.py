...
# --- 核心配置 ---
REQUEST_URL = "https://sit.api.expressfinance.business.hsbc.com/dpu-merchant/mock/generate-shop-performance"
REDIRECT_URL_PREFIX = "https://sit.api.expressfinance.business.hsbc.com/dpu-merchant/amazon/redirect?offerId="
HEADERS = {"Content-Type": "application/json"}
TIER_OPTIONS = {'1': ('TIER1', 120000), '2': ('TIER2', 950000), '3': ('TIER3', 2000000)}
FILE_PATH = r"D:\data\project\test\sit signup.txt"
